...
function getProfileUrl(scope, profileFields, skipFields) {
  ...
  return 'https://api.linkedin.com/v2/emailAddress?q=members&projection=(elements*(handle~))'
  // return 'https://api.linkedin.com/v2/me/emailAddress?q=memeber&projection=(' +
